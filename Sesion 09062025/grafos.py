...
print("--- Creacion de Grafo No Dirigido ---")
...
print(f"Vecinos de Fin (dirigido): {grafo_dirigido.obtener_vecinos("Fin")}")
print(f"Existe arista de A a B? {grafo_dirigido.existe_arista('A', 'B')}")
print(f"Existe arista de B a A? {grafo_dirigido.existe_arista('B', 'A')}")
...
print("\n--- Conectividad y Caminos en Grafos Dirigido ---")
